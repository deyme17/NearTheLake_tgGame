...
from bot.handlers.command_handlers import start, help_command, rule_command, end_game_command
...
def create_app():
    ...
    application.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND, handle_player_message))  # <== Додай це
