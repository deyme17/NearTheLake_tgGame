...
ACTION_1_CLEAR_VAL = -1   # Вплив на чистоту води дії 1
ACTION_2_CLEAR_VAL = 1    # Вплив на чистоту води дії 2

SCORE_PENALTY = 20        # Штраф, якщо гравець вибрав дію "скидання води"
SCORE_REWARD = 10   # Бонус для гравців, які вибрали "очищення води"
